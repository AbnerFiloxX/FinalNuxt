...
export default {
  ...
  methods: {
    async loadUsers() {
      const usuarios = await fetch('http://localhost:5000/get-users2');
    ...
    async borrar() {
      ...
      const rawResponse = await fetch('http://localhost:5000/delete-user2', {
        method: 'POST',
        headers: {
    ...
    async editar() {
      ...
      if (valid) {
        ...
        const rawResponse = await fetch('http://localhost:5000/edit-user2', {
          method: 'POST',
          headers: {
            Accept: 'application/json',
            'Content-Type': 'application/json',
    ...
    async registraUsuario() {
      ...
      if (this.frmRegistro) {
        ...
        const rawResponse = await fetch('http://localhost:5000/new-user2', {
          method: 'POST',
          headers: {
            Accept: 'application/json',
            'Content-Type': 'application/json',
